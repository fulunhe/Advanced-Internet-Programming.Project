  ...
  <div class="row">
    <div class="col-md-10 col-md-offset-1">
      <div class="panel panel-default">
       ...
       用户名：     <input type="text" name="name" class="form-control" required="required" value="{{ $admin->name }}">
            <br>
      邮箱： <input type="text" name="email" class="form-control" required="required" value="{{ $admin->email }}">
            <br>
            ...
            <button class="btn btn-lg btn-info">编辑管理员</button>
          </form>

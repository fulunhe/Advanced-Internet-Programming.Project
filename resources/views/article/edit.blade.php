...
<div class="container">  
  <div class="row">
    <div class="col-md-10 col-md-offset-1">
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          ...
          <form action="{{ URL('home/'.$article->id) }}" enctype="multipart/form-data" method="POST">
    ...
    type:
            ...
            <br>
             <br>
     content：<textarea name="body" rows="10" class="form-control" required="required">{{ $article->body }}</textarea>
            <br>
